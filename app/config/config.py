...
class Config:
    ...
    # WeCom: GeekAI/deepseek-v3-0324:free
    WECOM_APP_SECRET_GEEKAI_DEEPSEEK_V3_0324_FREE=os.environ.get('WECOM_APP_SECRET_GEEKAI_DEEPSEEK_V3_0324_FREE')
    WECOM_AGENT_ID_GEEKAI_DEEPSEEK_V3_0324_FREE=os.environ.get('WECOM_AGENT_ID_GEEKAI_DEEPSEEK_V3_0324_FREE')

    # WeCom: GeekAI/gemini-2.5-pro-exp-03-25
    WECOM_APP_SECRET_GEEKAI_GEMINI_2_5_PRO_EXP_03_25=os.environ.get('WECOM_APP_SECRET_GEEKAI_GEMINI_2_5_PRO_EXP_03_25')
    WECOM_AGENT_ID_GEEKAI_GEMINI_2_5_PRO_EXP_03_25=os.environ.get('WECOM_AGENT_ID_GEEKAI_GEMINI_2_5_PRO_EXP_03_25')

    # WeCom: GeekAI/multimodal-embedding-v1
    WECOM_APP_SECRET_GEEKAI_MULTIMODAL_EMBEDDING_V1=os.environ.get('WECOM_APP_SECRET_GEEKAI_MULTIMODAL_EMBEDDING_V1')
    WECOM_AGENT_ID_GEEKAI_MULTIMODAL_EMBEDDING_V1=os.environ.get('WECOM_AGENT_ID_GEEKAI_MULTIMODAL_EMBEDDING_V1')

    # WeCom: GeekAI/llama-4-maverick:free
    WECOM_APP_SECRET_GEEKAI_LLAMA_4_MAVERICK_FREE=os.environ.get('WECOM_APP_SECRET_GEEKAI_LLAMA_4_MAVERICK_FREE')
    WECOM_AGENT_ID_GEEKAI_LLAMA_4_MAVERICK_FREE=os.environ.get('WECOM_AGENT_ID_GEEKAI_LLAMA_4_MAVERICK_FREE')

    # WeCom: GeekAI/llama-4-scout:free
    WECOM_APP_SECRET_GEEKAI_LLAMA_4_SCOUT_FREE=os.environ.get('WECOM_APP_SECRET_GEEKAI_LLAMA_4_SCOUT_FREE')
    WECOM_AGENT_ID_GEEKAI_LLAMA_4_SCOUT_FREE=os.environ.get('WECOM_AGENT_ID_GEEKAI_LLAMA_4_SCOUT_FREE')

    # WeCom: GeekAI/gemini-2.5-pro-preview-03-25
    WECOM_APP_SECRET_GEEKAI_GEMINI_2_5_PRO_PREVIEW_03_25=os.environ.get('WECOM_APP_SECRET_GEEKAI_GEMINI_2_5_PRO_PREVIEW_03_25')
    WECOM_AGENT_ID_GEEKAI_GEMINI_2_5_PRO_PREVIEW_03_25=os.environ.get('WECOM_AGENT_ID_GEEKAI_GEMINI_2_5_PRO_PREVIEW_03_25')

    # Wecom: GeekAI/GLM-Z1-AirX
    WECOM_APP_SECRET_GEEKAI_GLM_Z1_AIRX=os.environ.get('WECOM_APP_SECRET_GEEKAI_GLM_Z1_AIRX')
    WECOM_AGENT_ID_GEEKAI_GLM_Z1_AIRX=os.environ.get('WECOM_AGENT_ID_GEEKAI_GLM_Z1_AIRX')

    # Wecom: GeekAI/ GLM-Z1-Air
    WECOM_APP_SECRET_GEEKAI_GLM_Z1_AIR=os.environ.get('WECOM_APP_SECRET_GEEKAI_GLM_Z1_AIR')
    WECOM_AGENT_ID_GEEKAI_GLM_Z1_AIR=os.environ.get('WECOM_AGENT_ID_GEEKAI_GLM_Z1_AIR')

    # Wecom: GeekAI/GLM-Z1-Flash
